...
class Auth extends CI_Controller {
        ...
        if($user) {
            ...
            if ($user['is_active'] == 1) {
              ...
              Wrong password!!</div>');
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">
              The email has not been activated !!</div>');
                redirect('auth');
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'addarroni@gmail.com',
            'smtp_pass' => 'nurulinayah',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('addarroni@gmail.com', 'Addar Roni');
